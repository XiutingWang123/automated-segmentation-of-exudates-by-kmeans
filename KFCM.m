function [center, U, obj_fcn] = KFCM(data, cluster_n, kernel_b,options)
% KFCM.m   采用模糊C均值对数据集data聚为cluster_n类  
%
% 用法：
%   1.  [center,U,obj_fcn] = KFCM(Data,N_cluster,kernel_b,options);
%   2.  [center,U,obj_fcn] = KFCM(Data,N_cluster,kernel_b);
%   3.  [center,U,obj_fcn] = KFCM(Data,N_cluster);
%   
% 输入：
